...
func init() {
	m.Register(func(app core.App) error {
		...
		collection, err := app.FindCollectionByNameOrId("releases_entity")
		if err != nil {
			collection = core.NewBaseCollection("releases_entity")
		}
		entitiesCol, _ := app.FindCollectionByNameOrId("entities")
